...
function App() {
  ...
  const apiKey="a40684caa18541b58a800609231201";
 ...
 console.log(city)
  ...
  return (
   ...
   <div className="glitch" data-glitch="Weather App">Weather App</div>
</div>
      <div className="searchbox">
      <div className="container">
<div className="search-container">
  <input onChange={(e)=>(setCity(e.target.value))} className="input" type="text" />
  <svg onClick={handleSubmit} viewBox="0 0 24 24" className="search__icon">
    <g>
  ...
  <div className="card">
    <p className="city">{data ?data.location.name:null}</p>
    <p className="weather">{data ? data.current.condition.text:null}</p>
    <svg
      className="weather"
      version="1.1"
      id="Layer_1"
    ...
    <p className="temp">{data ?data.current.temp_c:null}°</p>
...
{/* weather days forcecast */}

<div className="forecastContainer">
 <div className="head">5-days forecast</div>
 <div className="forecastCard">
  <div className="day">
    <p className="dayName">Mon</p>
    <p className="dayName">Mon</p>
    <p className="dayName">Mon</p>
    <p className="dayTemp">32°</p>
  </div>
